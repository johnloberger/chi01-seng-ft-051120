...
- get more comfortable with complex file structures in projects
- learn about gemfile and rake
- discover the joy of active record
- discuss migration mechanics (for changing db structure, tables, columns, etc)
- sketch out a familiar model domain, Active Record Style
