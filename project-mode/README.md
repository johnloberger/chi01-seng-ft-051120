...
- Review setup process for Active Record Migrations/Models
- Test a schema and its relationships by seeding data and running code in rake console
- Settle lingering questions about this week's codebase
...
User has many findings
User has many mushrooms through findings

Mushroom has many findings
Mushroom has many users through findings

User Stories:

User can see all mushrooms they found
- how does the user see users to type a choice from?
- how do I get all of a user's mushrooms?
user can add a new finding (C)
user can edit notes on a finding (U)
user can delete a finding (D)

User can see all known mushrooms that are not found ***
User can see all mushrooms in a given habitat ***
